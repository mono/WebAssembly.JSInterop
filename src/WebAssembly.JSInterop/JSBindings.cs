...
namespace WebAssembly.JSInterop
{
    ...
    */
    public sealed class JSInterop
    {
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::BindJSObject handle {js_id}");
#endif            
            JSObject obj;
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::BindJSObject object {obj.JSHandle}");
#endif            
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::UnBindJSObject {js_id}");
#endif            
            if (bound_objects.ContainsKey(js_id))
            {
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::UnBindJSObjectAndFree {js_id}");
#endif            
            if (bound_objects.ContainsKey(js_id))
            {
                var obj = bound_objects[js_id];
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::BindExistingObject {raw_obj.GetType()} - id / {js_id}");
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::GetJSObjectId from raw {raw_obj.GetType()}");
        ...
        {
#if DEBUG
            Console.WriteLine($"CS::WebAssembly.JSInterop::GetMonoObject {gc_handle}");
        ...
        //public static int GetJSGlobal(string str, bool isClrManaged = false)
        //{
        //    int exception = 0;
        //    var globalHandle = InternalCalls.GetJSGlobal(str, isClrManaged, out exception);
        ...
        public static double Int64ToDouble(long i64)
        {
            return (double)i64;
        }

        public static string TryConvertPrimitiveOrDecimal(object obj)
        {
            Type t = obj.GetType();
